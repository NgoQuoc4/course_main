...
const AuthContextProvider = ({ children }) => {
    ...
    const handleGetProfileCourse = async () => {
        try {
            ...
            // Biến đổi danh sách đơn hàng thành danh sách khóa học phẳng
            const allCourses = orders.reduce((acc, order) => {
                const orderCourses = order.courses.map(item => ({
                    ...item.course,
                    orderId: order._id, // Lưu lại ID đơn hàng nếu cần
