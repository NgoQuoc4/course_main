...
const CourseItem = ({
    ...
    // Ưu tiên dùng instructor (object mới), nếu không có mới tìm trong teams
    const teacher = instructor || teams?.find((item) => item.tags.includes(ROLES.teacher)) || {};

    const teacherName = teacher.firstName ? `${teacher.firstName} ${teacher.lastName || ""}`.trim() : (teacher.name || "");
    const teacherAvatar = teacher.avatar || teacher.image ? (teacher.avatar || teacher.image) : "/img/avatar.jpg";

    // Đảm bảo teacherAvatar có dấu / ở đầu nếu là đường dẫn nội bộ
        ...
        return (
            <div className="coursecoming__item">
                <div className="coursecoming__item-img">
                    <Link to={detailPath}>
                        <img src={displayImage} alt="Khóa học sắp ra mắt CFD" />
                    </Link>
                </div>
                    ...
                    {!!teacherName && (
                        <div className="user">
                            <div className="user__img">
                                <img src={formattedAvatar} alt="Avatar teacher" />
                            </div>
    ...
    return (
        <div className="courses__list-item">
            <div className="img">
                <Link to={detailPath}>
                    <img src={displayImage} alt="Khóa học CFD" className="course__thumbnail" />
                    {tags?.length > 0 && (
            ...
            <div className="content">
                ...
                <div className="content__info">
                    {!!teacherName && (
                        <div className="user">
                            <div className="user__img"><img src={formattedAvatar} alt="Avatar teacher" /></div>
                            <p className="user__name">{teacherName}</p>
                        </div>
                    )}
