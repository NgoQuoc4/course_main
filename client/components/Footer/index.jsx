            ...
            <div className="container">
                        ...
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/groups/cfdteam" target="_blank">
                                    {/* Added alt="" to these icons */}
                                    <i><img src="/img/icon-cfd-footer.svg" alt="" /></i>
                                    <span>Cộng đồng</span>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.facebook.com/cfdcircle" target="_blank">
                                    <i><img src="/img/icon-fb-footer.svg" alt="" /></i>
                                    <span>Facebook</span>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/cfdcircle" target="_blank">
                                    <i><img src="/img/icon-ytb-ft.svg" alt="" /></i>
                                    <span>Youtube</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>
                                <a href="https://goo.gl/maps/RnCAPv3CBjUgTUFd8" target="_blank">
                                    <i><img src="/img/icon-address.svg" alt="" /></i>
                            ...
                            <li>
                                <a href="mailto:info@cfdcircle.vn">
                                    <i><img src="/img/icon-mail.svg" alt="" /></i>
                ...
                <div className="bottom">
                    ...
                    <a href="./" target="_blank" className="logobct">
                        <img src="/img/logo-bo-cong-thuong.png" alt="Bộ Công Thương" />
                    </a>
                </div>
            </div>
        </footer>
